...
def test_penalty_is_proportional_to_area_share() -> None:
    ...
    def fingerprint(share: str) -> ProgramFingerprint:
        ...
        return ProgramFingerprint(program_id="program:09.03.01-02", program_code="09.03.01-02", program_name="Test", basis="hours", total_hours=100, total_credits=Decimal("10"), total_workload=Decimal("100"), area_hours={DisciplineAreaCode.PHYSICS_ASTRONOMY: physics * 100, DisciplineAreaCode.COMPUTER_SCIENCE_DATA: computer * 100}, area_share={DisciplineAreaCode.PHYSICS_ASTRONOMY: physics, DisciplineAreaCode.COMPUTER_SCIENCE_DATA: computer}, subject_group_hours={"base": Decimal("100")}, subject_group_share={"base": Decimal("1")}, semester_distribution={"1": Decimal("1")}, activity_signals={ActivityCode.SOFTWARE_CREATION: Decimal("1")})
