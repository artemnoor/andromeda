...
def test_explanations_reference_real_area_and_distinctive_evidence() -> None:
    ...
    fingerprint = ProgramFingerprint(program_id="program:09.03.01-02", program_code="09.03.01-02", program_name="Test", basis="hours", total_hours=100, total_credits=Decimal("10"), total_workload=Decimal("100"), area_hours={DisciplineAreaCode.COMPUTER_SCIENCE_DATA: Decimal("100")}, area_share={DisciplineAreaCode.COMPUTER_SCIENCE_DATA: Decimal("1")}, subject_group_hours={"major": Decimal("100")}, subject_group_share={"major": Decimal("1")}, semester_distribution={"1": Decimal("1")}, activity_signals={ActivityCode.SOFTWARE_CREATION: Decimal("1")}, evidence=(evidence,), distinctive_subjects=(DistinctiveSubject(source_name="Алгоритмы", normalized_name="алгоритмы", primary_area=DisciplineAreaCode.COMPUTER_SCIENCE_DATA, workload=Decimal("60"), share=Decimal("0.6"), rarity=Decimal("0.5"), distinctiveness=Decimal("0.3")),))
