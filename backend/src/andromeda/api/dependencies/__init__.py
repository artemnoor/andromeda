...
from .services import get_campus_point_reader, get_campus_service, get_compare_service, get_curriculum_reader, get_current_recommendation_service, get_discipline_reader, get_event_service, get_program_reader, get_proftest_catalog_reader, get_proftest_catalog_service, get_proftest_service, get_recommendation_service
