  ...
  return (
    <div>
      <PageHeader
        eyebrow="События"
        title="События МГТУ"
        description="Дни открытых дверей, лекции, конкурсы и карьерные ярмарки. Все события привязаны к официальным источникам. Можно отфильтровать по рекомендованным вашим программам."
      />
